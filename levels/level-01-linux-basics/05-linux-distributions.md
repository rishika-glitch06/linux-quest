...
✅ 03 - Why Linux?
✅ 04 - Linux Kernel
🟢 05 - Linux Distributions (Current Lesson)
⬜ 06 - GUI vs CLI
⬜ 07 - Terminal Basics
⬜ 08 - First Commands
```
...
- Understand what a Linux Distribution (Distro) is
- Learn why different Linux distributions exist
- Know the difference between Linux Kernel and Linux Distribution
- Explore popular Linux distributions
- Choose the right distribution based on your goals

---

# 👋 Let's Start

After learning about the Linux Kernel, one question naturally comes up...

If Linux is just the Kernel, then what exactly are Ubuntu, Fedora, Debian, Kali Linux, Arch Linux, and Linux Mint?

Are they all different operating systems?

Do they all use different Kernels?
